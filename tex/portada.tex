\begin{tikzpicture}[remember picture,overlay]
    ...
    %%%%%% LETRAS %%%%%
    \node[anchor=south,right] at ([xshift=-5.55\outermarginwidth, yshift=-.465\paperheight]current page.north) {\selectfont           \color{cw0}\cabin\bfseries\fontsize{70}{70}\selectfont PROBABILIDAD};
    \node[anchor=south,right] at ([xshift=-5.50\outermarginwidth, yshift=-.57\paperheight]current page.north) {\selectfont           \color{white}\cabin\bfseries\fontsize{53}{53}\selectfont CON APLICACIONES};
    %\node[anchor=west, font=\cabin\fontsize{23}{23}\selectfont, text=white] at ([xshift=1.5\outermarginwidth, yshift=-0.25\covershift]current page.west) {CON APLICACIONES};
    \node[anchor=west, font=\cabin\LARGE, text=black] at ([xshift=-1.5\outermarginwidth, yshift=-2.3\covershift]current page.center) {Antonio M. Mendoza ~$\bullet$~ Luis A. Godínez};
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture,overlay]%
      \coordinate (A) at ($(current page.north)+(2.65455,0)$);
      \coordinate[below=6.2cm of A] (B);
      \draw[cw0,line width=8.23pt] (A) -- (B);
\end{tikzpicture}


\vspace{2cm}
\begin{center}
\noindent\scalebox{6}{\fontencoding{T1}\fontfamily{pag}\selectfont\color{cw0}\textbf{PROBABILIDAD}}\\[1cm]
\noindent\scalebox{4.2}{\fontencoding{T1}\fontfamily{pag}\selectfont\color{cw2}\textbf{CON APLICACIONES}}\\[2cm]
